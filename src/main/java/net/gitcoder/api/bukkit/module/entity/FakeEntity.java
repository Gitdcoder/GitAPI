package net.gitcoder.api.bukkit.module.entity;
...
import net.gitcoder.api.bukkit.module.entity.animation.FakeEntityAnimation;
import net.gitcoder.api.bukkit.module.entity.equipment.FakeEntityEquipment;
import net.gitcoder.api.java.packet.entity.*;
